        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <a
                href="https://www.instagram.com/economysuprimentos/"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-primary-foreground/10 w-10 h-10 rounded-full flex items-center justify-center hover:bg-primary-foreground/20 transition-colors"
                aria-label="Instagram"
              >
                <Instagram size={20} />
              </a>
              <a
                href="https://www.facebook.com/economysuprimentosoficial/"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-primary-foreground/10 w-10 h-10 rounded-full flex items-center justify-center hover:bg-primary-foreground/20 transition-colors"
                aria-label="Facebook"
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <a href="tel:+556733877740" className="hover:text-accent transition-colors">
                  (67) 3387-7740
                </a>
              </li>
              <li className="flex items-start gap-2">
              ...
              <li className="flex items-start gap-2">
                ...
                <a
                  href="https://maps.google.com/?q=Rua+Osmar+de+Andrade,+333+Jd+Colibri+Campo+Grande+MS"
                  target="_blank"
                  rel="noopener noreferrer"
